...
CREATE TABLE `decoration_plan` (
  ...
  `category_id` bigint NOT NULL COMMENT '关联分类ID（关联PG中的分类表ID，跨库关联）',
...
-- 10. 材料出入库记录表 material_stock_record
